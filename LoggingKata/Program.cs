        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int x = 0; x < locations.Length; x++)
                {
                    ...
                    corB.Latitude = locations[x].Location.Latitude;
                    corB.Longitude = locations[x].Location.Longitude;
            ...
            logger.LogInfo($"The two locations furthest away from each other are {tacobell1.Name} and {tacobell2.Name} with a distance of {parser.ConvertMetersToMiles(distance)}");
